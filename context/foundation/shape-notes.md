...
checkpoint:
  ...
  frs_drafted: 11
  quality_check_status: scope-revised
updated: 2026-08-29 — SINGLE-USER MVP WITH AI TASK GENERATION
---
...
**done yet?** externalizes household task management into a simple, durable system. Users create a list of household duties with due dates, check in daily on what's due today, and mark tasks complete as they go. The app becomes the household's shared brain, freeing the user from the cognitive load of remembering.
...
**User scope**: Single-user MVP. One account = one household. Multi-user household sharing deferred to v1.1.
...
### Primary
A user registers, creates a household, creates tasks with due dates, views today's tasks on the dashboard, and marks tasks complete. Users can ask the AI to generate household task suggestions, accept/customize them, and save them as tasks. The app feels fast and reliable. New user setup (register + create household + first task) takes < 5 minutes.

### Secondary
Users return daily to check their task list and feel the app reduces their mental load of remembering household duties. At least 70% of AI-generated task suggestions are accepted by users.

### Guardrails
- Task creation, editing, and completion feel instant (<500ms)
- No data loss or sync failures
- User data is stored securely and persists across sessions
- App is usable on desktop and mobile browsers
- AI task suggestions are relevant and actionable (70% acceptance rate target)

### Timeline acknowledgment
Acknowledged on 2026-08-29: Single-user MVP with AI task generation (11 FRs) reduces timeline to 2.5–3 weeks of focused work. Scope includes: auth, household setup, task CRUD, dashboard, AI task generation. Deferred to v1.1: multi-user sharing, categories, recurring tasks, Telegram bot.
...
**Core Rule**: The app is an external brain for household task management, powered by AI-generated suggestions. Instead of remembering dozens of duties, the user externalizes them into a durable list. The AI surfaces relevant household tasks based on the user's household characteristics (kids, pets, house type), reducing the cognitive work of discovery. Users accept or reject suggestions, building their task list through guided discovery rather than blank-slate creation.
...
- **Complex permission models** — single-user MVP

## Product Framing

**Product Type**: Web app (browser-based, responsive for desktop and mobile)

**Target Scale**: Single user to dozens of households in early adoption phase. Initial audience: friends, family, early adopters. Growth strategy is post-MVP.

**Timeline**: Single-user MVP with AI task generation
- Estimated MVP work: 2.5–3 weeks of focused work
- Timeline acknowledged: 2026-08-29 (scope: single-user, AI task generation, no Telegram, no categories)
- Target launch: mid-September 2026

**Context**: Focused development effort (evenings/weekends or dedicated sprint).
